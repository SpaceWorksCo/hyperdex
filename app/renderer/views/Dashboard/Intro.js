		...
		return (
			...
			>
				<Trans i18n={instance} i18nKey="intro.description" t={t}>
					...
					<p>Although loss of funds is unlikely, you should only trade with real currency if you can take that
						risk.</p>
					<p>If you just want to test HyperDEX, try trading between the test
						currencies <strong>RICK</strong> and <strong>MORTY</strong> instead. You can get
						free <strong>RICK</strong> <ExternalLink
							url="https://www.atomicexplorer.com/#/faucet/rick">here</ExternalLink> and
						free <strong>MORTY</strong> <ExternalLink
							url="https://www.atomicexplorer.com/#/faucet/morty">here</ExternalLink>.</p>
					<p>HyperDEX is Open Source software provided &qoute;as is&qoute;, without warranty of any kind. The
